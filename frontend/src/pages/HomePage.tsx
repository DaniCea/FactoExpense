  ...
  return (
    <div className="max-w-[720px] mx-auto">
      <div className="block mb-4 mx-auto border-b border-slate-300 pb-2 max-w-[360px]">
        <a target='_blank' rel="noreferrer" href='https://www.material-tailwind.com/docs/html/table' className='block w-full px-4 py-2 text-center text-slate-700 transition-all '>
